...
Standalone-установка сразу допускает все шесть перечисленных валют для каждого встроенного платёжного актива. Система сравнивает наблюдения CoinGecko и CoinPaprika, а для KZT дополнительно использует официальный ежедневный USD/KZT Национального банка Казахстана. Любой другой трёхбуквенный код сам по себе котировку не создаёт: в production всё равно нужен свежий допущенный курс для точной пары `asset_id`/валюта. Отсутствующий, устаревший, не набравший quorum, будущий или чрезмерно разошедшийся курс закрывается с ошибкой.
