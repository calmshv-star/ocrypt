...
-- This migration corrects PostgreSQL name resolution without changing the
-- accepted policy language. Keep the corrected definitions on rollback so a
-- down migration cannot re-introduce a configuration admission outage.
