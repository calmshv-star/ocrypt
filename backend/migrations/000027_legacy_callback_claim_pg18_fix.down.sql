...
-- The rollback deliberately retains the qualified PostgreSQL 18-safe body.
-- Reintroducing the ambiguous output-column reference would stop all legacy
-- callback delivery immediately after a rollback.
