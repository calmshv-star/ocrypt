...
export const intents: PaymentIntent[] = [
  ...
  { id: "pi_01JQ8EQM4Y1A", orderId: "P-886241", merchant: "Kepler Market", customer: "buyer_G3AV", fiat: "$410.00", route: "TON · GRAM", received: "307.21 GRAM", status: "needs_review", expires: "Expired", created: "10 Aug, 10:58" },
...
export const transfers: Transfer[] = [
  ...
  { id: "evt_ton_4V8", hash: "3f42e1bc5981604098d215f88ed0f29b4903e39a5933d1f3aa6b23a5f5b40934", eventIndex: "lt:52188421000003", network: "TON", asset: "GRAM", amount: "307.21 GRAM", fiat: "$407.84", from: "0:42ca…710d", to: "0:1aa9…9c0e", block: "wc0:48,991,221", confirmations: 1, finality: "observed", match: "unmatched", observedAt: "11:05:02" },
...
export const unmatchedCases: UnmatchedCase[] = [
  ...
  { id: "case_01JQ8E92", transferId: "evt_ton_4V8", network: "TON", asset: "GRAM", amount: "307.21 GRAM", fiat: "$407.84", reason: "late", risk: "low", age: "37 min", assignee: "Maya Chen", sla: "23 min", candidates: [{ intentId: "pi_01JQ8EQM4Y1A", orderId: "P-886241", merchant: "Kepler Market", score: 98, evidence: ["Exact address", "Exact route amount", "Block time is 4m after expiration"] }] },
...
export const assetHealth: AssetHealth[] = [
  ...
  { network: "TON", asset: "GRAM / Jettons", strategy: "Masterchain + account tx", readiness: 74, scannerLag: "18 blocks", quorum: "2 / 3", capacity: 57, status: "degraded" },
