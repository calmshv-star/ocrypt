...
export function SettingsPage() {
  ...
  return <div className="admin-page">
    <PageHeader actions={<Button><Save size={15} />{t("settings.save")}</Button>} description={t("page.settings.description")} eyebrow={<><Settings2 size={13} />{t("common.previewData")}</>} title={t("page.settings.title")} />
