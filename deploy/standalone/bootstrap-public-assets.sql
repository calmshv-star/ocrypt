...
WITH desired(asset_id,chain_id,dust_threshold) AS (
  VALUES
    ...
    ('usdt-polygon','eip155:137',100::numeric),
    ('usdce-polygon','eip155:137',100::numeric),
    ('bnb-bsc','eip155:56',1000000000::numeric),
    ('usdt-bsc','eip155:56',100000000000000::numeric),
    ('usdc-bsc','eip155:56',100000000000000::numeric),
    ('usdt-plasma','eip155:9745',100::numeric),
    ('usdc-aptos','aptos:1',100::numeric),
    ('usdt-aptos','aptos:1',100::numeric)
)
